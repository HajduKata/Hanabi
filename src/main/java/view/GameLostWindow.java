...
public class GameLostWindow extends JFrame implements ActionListener {
    private GameTable gameTable;
    private JButton newGameButton;
    private JButton exitGameButton;
    public Boolean done = null;

    public GameLostWindow(GameTable gameTable) {
        ...
        String losingText = "Sajnos elvesztetted az összes életedet!";
        JLabel nameLabel = new JLabel(losingText);
